...
namespace Aiursoft.Apkg.Sqlite.Migrations
{
    ...
    [Migration("20260601183327_DropIsPublishedRenameVaultPathRenameTable")]
    partial class DropIsPublishedRenameVaultPathRenameTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aiursoft.Apkg.Entities.ApkgRevision", b =>
                {
                    ...
                    b.Property<string>("TempApkgFileInVaultPath")
                        .HasMaxLength(512)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Aiursoft.Apkg.Entities.DependencyCheckReport", b =>
                {
                    ...
                    b.Property<int>("ProblematicPackages")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("DependencyCheckReports");
                });
            ...
            modelBuilder.Entity("Aiursoft.Apkg.Entities.UserApiKey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Aiursoft.Apkg.Entities.UserApiKey", b =>
                {
                    b.HasOne("Aiursoft.Apkg.Entities.User", "User")
                        .WithMany()
