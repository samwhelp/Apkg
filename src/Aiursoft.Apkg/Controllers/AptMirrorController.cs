    ...
    FeatureFoldersProvider folders) : ControllerBase
{
    ...
    /// pool Filenames to "{suite}/pool/main/…" so that APT constructs download URLs of the
    /// form ".../artifacts/{distro}/{suite}/pool/main/…".  Handling those here lets us pass
    ...
    /// </summary>
    [HttpGet]
    [Route("artifacts/{distro}/{suite}/pool/{**path}")]
